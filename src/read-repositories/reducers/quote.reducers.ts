...
const quoteSubmitted: ReadRepositoryReducer<IQuoteSubmittedEventPayload> =
...
const pendingQuoteAccepted: ReadRepositoryReducer<IPendingQuoteAcceptedPayload> =
  async ({ revision, data }, manager) => {
...
const pendingQuoteCancelled: ReadRepositoryReducer<IPendingQuoteCancelledPayload> =
  async ({ revision, data }, manager) => {
...
const quoteReceived: ReadRepositoryReducer<IQuoteReceivedPayload> = async (
  { revision, data },
  manager,
) => {
  const { quoteId } = data
